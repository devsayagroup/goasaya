...
export const menuData: MenuCategory[] = [
  ...
  {
    name: "To Start",
    heroImage: "/menu/tostart/cured-salmon.jpg",
  ...
  {
    name: "To Share",
    heroImage: "/menu/toshare/sate-padang.jpg",
    // featured: ["Soft Shell Crab", "Griffin’s Signature"],
    items: [
      {
  ...
  {
    name: "Pasta",
    heroImage: "/menu/pasta/beef-pappardelle.jpg",
    // featured: ["Soft Shell Crab", "Griffin’s Signature"],
    items: [
      {
        ...
        price: "170.000",
        image: "/menu/pasta/creamy-chicken.jpg",
      },
      {
  ...
  // ------------------ DESSERT ------------------
  {
    ...
    heroImage: "/menu/dessert/zen-stone.jpg",
