...
export default function PrivateEvents() {
  ...
  // Facilities Data
  const facilities = [
      { id: "01", title: "Club-Grade Audio", desc: "Integrated sound system and DJ equipment acoustically mapped for the cave's unique structure." },
      { id: "02", title: "VIP Valet Service", desc: "A seamless arrival experience with dedicated, priority valet parking for your guests." },
      { id: "03", title: "Bespoke Mixology", desc: "Access to private bar stations and dedicated mixologists for customized event cocktails." },
      { id: "04", title: "Ambient Illumination", desc: "Dynamic, customizable lighting systems to match your brand identity or desired mood." },
      { id: "05", title: "Discreet Access", desc: "Private entryways ensuring complete confidentiality for executives and high-profile attendees." },
      { id: "06", title: "Corporate Ready", desc: "High-speed Wi-Fi and flexible floor plans to accommodate presentations and networking." },
  ];
  ...
  return (
    <main ref={containerRef} className="bg-[#0B0502] text-white/90 font-text relative selection:bg-[#FFE3AF] selection:text-[#0B0502]">
        ...
        {/* 4. THE INVESTMENT */}
        <section className="relative w-full pt-32 md:pt-48 pb-16 z-20 bg-[#0B0502]">
            <div className="container mx-auto px-6 md:px-14">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 border-b border-white/10 pb-10">
                    <div>
                        <h2 className="text-4xl md:text-6xl font-style uppercase text-white">The Investment</h2>
        ...
        {/* 5. FACILITIES & AMENITIES (NEW SECTION) */}
        <section className="relative w-full py-16 md:py-24 z-20 bg-[#0B0502]">
            <div className="container mx-auto px-6 md:px-14">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 border-b border-white/10 pb-8">
                    <div>
                        <h2 className="text-4xl md:text-6xl font-style uppercase text-white">Amenities</h2>
                        <p className="text-[#FFE3AF] uppercase tracking-[0.2em] text-xs mt-4">Venue Facilities</p>
                    </div>
                    <p className="text-sm text-white/50 max-w-sm md:text-right font-light leading-relaxed">
                        Equipped with state-of-the-art infrastructure to ensure your event executes flawlessly from arrival to departure.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {facilities.map((feature, idx) => (
                        <motion.div 
                            ...
                            className="group p-8 border border-white/5 bg-white/[0.01] hover:bg-[#FFE3AF]/5 hover:border-[#FFE3AF]/30 transition-all duration-500 rounded-sm"
                        >
                            <span className="text-[#FFE3AF] text-xs uppercase tracking-widest block mb-4">{feature.id}</span>
                            <h4 className="text-2xl font-style uppercase text-white mb-3 group-hover:text-[#FFE3AF] transition-colors">{feature.title}</h4>
