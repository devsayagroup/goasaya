...
//                     fill
//                     sizes="(max-width: 768px) 80vw, 40vw"
//                     // ✅ FIX: Removed quality={60} to eliminate the Next.js config warning
//                     className="object-cover object-center" 
//                     priority={isPriority}
//                   />
//                 </div>
...
//       <div className="relative container flex flex-col lg:flex-row mx-auto justify-between lg:items-center px-6 pt-[30em] lg:pt-0 md:px-14 z-20">
//         <motion.h1
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ duration: 0.8 }}
